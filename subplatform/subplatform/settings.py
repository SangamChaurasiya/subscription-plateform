...
SECRET_KEY = 'django-insecure-(oqqe#x&pj32-)&tuphxxef$^wd+trp#jiwuca$(sn7=dh0z!+'
...
if config('IS_TESTDB', cast=bool) in [True, 'True']: 
    ...
    DATABASES = {
        'default': dj_database_url.parse(config('POSTGRESQL_DATABASE_EXTERNAL_URL'))
    }
